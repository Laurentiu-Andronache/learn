...
export function SubModeSelector({
  ...
  const modes: {
  ...
  }[] = [
    {
      ...
      subMode: "full",
      count: counts.full,
      disabled: counts.full === 0,
    },
    {
      key: "quickReview",
      subMode: "quick_review",
      count: counts.quickReview,
      disabled: counts.quickReview === 0,
    },
    {
      key: "spacedRepetition",
      subMode: "spaced_repetition",
      count: counts.spacedRepetition,
      disabled: counts.spacedRepetition === 0,
    },
    {
      key: "categoryFocus",
